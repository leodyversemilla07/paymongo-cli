...
// Import templates
import {
    getWebhookHandlerTemplate as getJsWebhookHandler,
} from '../../src/commands/generate/templates/webhook-handler/javascript.js';
import {
    getWebhookHandlerTemplate as getTsWebhookHandler,
} from '../../src/commands/generate/templates/webhook-handler/typescript.js';
import {
    getPaymentIntentTemplate as getJsPaymentIntent,
} from '../../src/commands/generate/templates/payment-intent/javascript.js';
import {
    getPaymentIntentTemplate as getTsPaymentIntent,
} from '../../src/commands/generate/templates/payment-intent/typescript.js';
import {
...
describe('Generate Templates Integration', () => {
    ...
    describe('Webhook Handler Templates', () => {
        ...
        it('should include all specified events in handlers', () => {
            const manyEvents = ['payment.paid', 'payment.failed', 'payment.refunded', 'source.chargeable'];
